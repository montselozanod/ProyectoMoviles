...
@property (weak, nonatomic) IBOutlet UIButton *medallaBiodiversidad;
@property (weak, nonatomic) IBOutlet UIButton *medallaReciclaje;
@property (weak, nonatomic) IBOutlet UIButton *medallaRenovables;
@property (weak, nonatomic) IBOutlet UIButton *medallaAgua;
@property (weak, nonatomic) IBOutlet UIButton *trofeo;
...
@property (weak, nonatomic) IBOutlet UILabel *puntos;
